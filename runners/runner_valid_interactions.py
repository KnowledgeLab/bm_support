...
def run(origin, version, an_version, model_type, n_trials, n_subtrials, n_estimators, datapath=None,
    ...
    df_train, df_test = sample_by_length(dfw, (up, dn), head=10, seed=13, frac_test=0.4, verbose=True)
    ...
    func = partial(study_sample, dfw=df_train, target=target, feature_dict=feature_dict, metric_mode=mm,
