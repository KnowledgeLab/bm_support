...
if study_sample_flag:
    r = study_sample(dfw=dfw, target=dist, feature_dict=feature_dict_new, metric_mode=mm,
    ...
    r = select_features_dict(df_train, df_test, target_column, feature_dict, model_type='rfr', max_features_consider=8,
                             metric_mode='accuracy', mode_scores=None,
                             metric_uniform_exponent=0.5, eps_improvement=1e-6,
                             model_dict=param_dict, verbose=False)
